...
set "SLN_PATH=E:\Related_Github_Project\gmp_pro\ctl\suite\Main11\project\simulate\GMP_Motor_Control_simulink.sln"
...
if exist "%CURRENT%\tools\facilities_generator\gmp_fac_generate_srcs_example.bat" (
    if exist "E:\Related_Github_Project\gmp_pro\ctl\suite\Main11\project\simulate\GMP_Motor_Control_simulink.sln" (
