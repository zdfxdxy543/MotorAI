...
class FrameworkUserGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("GMP Project Framework Configurator V9 (English & Verification Reports)")
        ...
        # [NEW] Path to read developer markdown notes
    ...
    def build_ui(self):
        ...
        # ------ Tab 2: Verification Report (NEW & READ-ONLY) ------
    ...
    def render_verification_report(self, root_name, mod_key, mod_data):
        """【NEW】 Render beautifully formatted read-only Verification Report"""
        ...
        if mod_key.endswith("_internal"):
            ...
            if not tasks:
                ...
                for task in tasks:
                    ...
                    # Load external Markdown notes if available
