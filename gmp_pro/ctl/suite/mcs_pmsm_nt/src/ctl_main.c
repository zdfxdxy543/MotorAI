...
void ctl_init()
{
    ...
    mtr_ctrl_init.kid = 0.035 * CONTROLLER_FREQUENCY;
    mtr_ctrl_init.kiq = 0.035 * CONTROLLER_FREQUENCY;
    mtr_ctrl_init.kpd = 0.2;
    mtr_ctrl_init.kpq = 0.2;
    ...
    mech_init.pos_kp = 3.0f;
    mech_init.pos_ki = 0.024f;

    mech_init.vel_kp = 5.0f;
    mech_init.vel_ki = 0.002f * CONTROLLER_FREQUENCY;

    mech_init.speed_limit = 0.1f;

#if BUILD_LEVEL <= 4
    mech_init.speed_slope_limit = 1.0f;
#else
    mech_init.speed_slope_limit = 100.0f;
#endif

    mech_init.pos_slope_limit = 10.0f;
    mech_init.cur_limit = 2.5f;
