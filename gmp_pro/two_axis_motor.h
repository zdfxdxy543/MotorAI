...
#ifndef _FILE_MOTOR_PARAM_TwoAxis_H_
#define _FILE_MOTOR_PARAM_TwoAxis_H_
...
//================================================================================
#define MOTOR_PARAM_RS ((0.34f))     ///< Stator resistance per phase (Ohm).
...
//================================================================================
#define MOTOR_PARAM_POLE_PAIRS ((5))     ///< Number of pole pairs in the motor.
#define MOTOR_PARAM_INERTIA    ((350.0f)) ///< Total rotor inertia (g*cm^2).
...
#define MOTOR_PARAM_EMF ((10.0f))  ///< Back-EMF constant (V/kRPM).

//================================================================================
// Rated Operating Parameters
//================================================================================
#define MOTOR_PARAM_RATED_VOLTAGE   ((48.0f))  ///< Rated operating voltage (V).
#define MOTOR_PARAM_RATED_CURRENT   ((22.0f))   ///< Rated phase current (A, Peak).
...
#define MOTOR_PARAM_MAX_TORQUE     ((2.54f)) ///< Maximum intermittent torque (N*m).
