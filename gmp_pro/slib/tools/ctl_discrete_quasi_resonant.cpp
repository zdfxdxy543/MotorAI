/*
 * File: ctl_discrete_quasi_resonant.cpp
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Sep 15 23:14:20 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ctl_discrete_quasi_resonant
...
extern void ctl_discrete_quasi_resonant_Start_wrapper(real_T *xD,
  void **pW,
  const real_T *pr_param, const int_T p_width0,
  const real_T *ctrl_freq, const int_T p_width1,
  SimStruct *S);
extern void ctl_discrete_quasi_resonant_Outputs_wrapper(real_T *y0,
  const real_T *xD,
  void **pW,
  const real_T *pr_param, const int_T p_width0,
  const real_T *ctrl_freq, const int_T p_width1,
  SimStruct *S);
extern void ctl_discrete_quasi_resonant_Update_wrapper(const real_T *u0,
  real_T *y0,
  real_T *xD,
  void **pW,
  const real_T *pr_param, const int_T p_width0,
  const real_T *ctrl_freq, const int_T p_width1,
  SimStruct *S);
extern void ctl_discrete_quasi_resonant_Terminate_wrapper(real_T *xD,
  void **pW,
  const real_T *pr_param, const int_T p_width0,
  const real_T *ctrl_freq, const int_T p_width1,
  SimStruct *S);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function ctl_discrete_quasi_resonant");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function ctl_discrete_quasi_resonant");
      return;
    }
...
static void mdlStart(SimStruct *S)
{
  ...
  ctl_discrete_quasi_resonant_Start_wrapper(xD, pW, pr_param, p_width0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *pr_param = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  ctl_discrete_quasi_resonant_Outputs_wrapper(y0, xD, pW, pr_param, p_width0,
    ctrl_freq, p_width1, S);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const real_T *pr_param = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  ctl_discrete_quasi_resonant_Update_wrapper(u0, y0, xD, pW, pr_param, p_width0,
    ctrl_freq, p_width1, S);
}
...
static void mdlTerminate(SimStruct *S)
{
  ...
  const real_T *pr_param = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  ctl_discrete_quasi_resonant_Terminate_wrapper(xD, pW, pr_param, p_width0,
    ctrl_freq, p_width1, S);
}
