 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Sep 15 23:14:18 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ctl_discrete_pid
...
extern void ctl_discrete_pid_Start_wrapper(real_T *xD,
  void **pW,
  ...
  SimStruct *S);
extern void ctl_discrete_pid_Outputs_wrapper(const real_T *u0,
  real_T *y0,
  const real_T *xD,
  void **pW,
  const real_T *pid_param, const int_T p_width0,
  ...
  const real_T *ctrl_freq, const int_T p_width2,
  SimStruct *S);
extern void ctl_discrete_pid_Update_wrapper(const real_T *u0,
  real_T *y0,
  real_T *xD,
  void **pW,
  const real_T *pid_param, const int_T p_width0,
  ...
  const real_T *ctrl_freq, const int_T p_width2,
  SimStruct *S);
extern void ctl_discrete_pid_Terminate_wrapper(real_T *xD,
  void **pW,
  const real_T *pid_param, const int_T p_width0,
  const real_T *pid_minmax, const int_T p_width1,
  const real_T *ctrl_freq, const int_T p_width2,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function ctl_discrete_pid");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function ctl_discrete_pid");
      return;
    }
...
static void mdlStart(SimStruct *S)
{
  ...
  const real_T *pid_param = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *pid_minmax = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  ctl_discrete_pid_Start_wrapper(xD, pW, pid_param, p_width0, pid_minmax,
    p_width1, ctrl_freq, p_width2, S);
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *pid_minmax = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  ctl_discrete_pid_Outputs_wrapper(u0, y0, xD, pW, pid_param, p_width0,
    pid_minmax, p_width1, ctrl_freq, p_width2, S);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const real_T *pid_minmax = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  ctl_discrete_pid_Update_wrapper(u0, y0, xD, pW, pid_param, p_width0,
    pid_minmax, p_width1, ctrl_freq, p_width2, S);
}
...
static void mdlTerminate(SimStruct *S)
{
  ...
  const real_T *pid_minmax = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *ctrl_freq = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  ctl_discrete_pid_Terminate_wrapper(xD, pW, pid_param, p_width0, pid_minmax,
    p_width1, ctrl_freq, p_width2, S);
}
