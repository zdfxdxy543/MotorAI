...
typedef GTI_RETURN_TYPE (GTI_FN_SET_WAIT_IN_RESET)(GTI_HANDLE_TYPE, BOOL);

/** Function type for GTI_GET_WAIT_IN_RESET_MODE(). */
typedef GTI_RETURN_TYPE (GTI_FN_GET_WAIT_IN_RESET_MODE)(GTI_HANDLE_TYPE, BOOL*);
...
GTI_SET_WAIT_IN_RESET(
    GTI_HANDLE_TYPE hpid,      /**< [in]  GTI API instance handle. */
    BOOL            bWIREnable /**< [in]  Flag to turn on or off WIR mode. */
    );
...
GTI_GET_WAIT_IN_RESET_MODE(
    GTI_HANDLE_TYPE  hpid,      /**< [in]  GTI API instance handle. */
    BOOL            *bWIREnable /**< [out] Pointer to return current WIR mode setting. */
    );
