...
//
void init_gti_librarys()
{
    // return
    bool success = true;

    // Load the emulation driver into memory.
    HMODULE hDVR = LoadLibrary(C28X_DRIVER);
    ...
    if (success)
    {
        ...
        GTI_CONFIG = (GTI_FN_SETUP_PROPERTIES *)GetProcAddress(hDVR, "GTI_CONFIG");

        // TRG REALTIME CONFIG functions

        // Controls real-time mode setting.
        GTI_REALTIME_SWITCH = (GTI_FN_SETUP_PROPERTIES *)GetProcAddress(hDVR, "GTI_REALTIME_SWITCH");
        // Gets the non-intrusive features of the driver.
        GTI_GET_NON_INTRUSIVE_CAPABILITIES =
            (GTI_FN_SETUP_PROPERTIES *)GetProcAddress(hDVR, "GTI_GET_NON_INTRUSIVE_CAPABILITIES");
        ...
        GTI_READMEM_WITH_STAT_64 = (GTI_FN_GET_TARGET_PROPERTIES *)GetProcAddress(hDVR, "GTI_READMEM_WITH_STAT_64");
        // Write target memory with 64-bit memory addresses.
        GTI_WRITEMEM_WITH_STAT_64 = (GTI_FN_GET_TARGET_PROPERTIES *)GetProcAddress(hDVR, "GTI_WRITEMEM_WITH_STAT_64");
        ...
        if (0 == GTI_INIT_EX || 0 == GTI_QUIT || 0 == GTI_CONNECT || 0 == GTI_DISCONNECT || 0 == GTI_GETERRSTR_EX3 ||
            0 == GTI_READREG || 0 == GTI_WRITEREG || 0 == GTI_WRITEMEM_BLK || 0 == GTI_READMEM_BLK)
        {
